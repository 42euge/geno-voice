...
def test_dispatch_default_handlers_are_the_real_cmds():
    ...
    assert gv.DEFAULT_HANDLERS == {
        "agent": gv.cmd_agent,
        "start-endpoint": gv.cmd_start_endpoint,
        "bench": gv.cmd_bench,
        ...
        "calibrate-base-wpm-batch": gv.cmd_calibrate_base_wpm_batch,
        "stt-rtf": gv.cmd_stt_rtf,
        "stt-rtf-batch": gv.cmd_stt_rtf_batch,
        "vad": gv.cmd_vad,
        ...
        "vad-gap-recommend-batch": gv.cmd_vad_gap_recommend_batch,
