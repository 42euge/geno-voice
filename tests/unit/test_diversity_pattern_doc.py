...
_DIVERSITY_HELPERS = (
    ...
    "_emit_llm_tps_consistency_line",      # iter-142
    "_emit_streaming_overlap_consistency_line",  # iter-143
)
...
def test_doc_references_each_responsible_iteration():
    ...
    expected_iters = [
        ...
        "iter-142",  # llm-tps (4th continuous; first inverted-direction)
        "iter-143",  # overlap (5th continuous; second inverted-direction)
    ]
...
def test_doc_template_claims_match_actual_instance_count():
    ...
    counts = {
        ...
        6: ("six instances", "Six"),
        7: ("seven instances", "Seven"),
        8: ("eight instances", "Eight"),
    }
